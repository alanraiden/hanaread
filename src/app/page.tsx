...
export const metadata: Metadata = {
  title: "Read Korean Novels Free",
  description:
    "Discover the best Korean  novels in English. Read trending titles, explore new translations, and follow your favorite stories — updated weekly.",
  alternates: {
    canonical: "/",
  },
};
